...
const CreateTTAccount = ({ show, handleClose }) => {
    ...
    const onSubmit = async (obj) => {
      const { data } = await Services.AddTTAccount({ ...obj, serviceProvider: userLoggedIn._id });
    ...
    return (
      <>
        ...
        <Modal show={show} onHide={() => { handleClose(); reset({ userName: null, link: null, likes: null, followers: null })}}>
...
export default CreateTTAccount;
